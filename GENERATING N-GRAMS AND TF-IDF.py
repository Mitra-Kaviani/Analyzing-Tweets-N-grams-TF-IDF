...
bigrams_list = list(nltk.bigrams(text_content))#nltk.bigrams, 
dictionary2 = [' '.join(tup) for tup in bigrams_list]
vectorizer = CountVectorizer(ngram_range=(2,2))#bigrams
#vectorizer = CountVectorizer(ngram_range=(1, 1))#onegrams
...
#WRITING CSV FILE FOR ONE-GRAMS AND TWO-GRAMS OUT PUT ////////////////////////////////
#df2.to_csv('Bi_grams_DATA.csv')
df2.to_csv('Two_grams_DATA.csv')
